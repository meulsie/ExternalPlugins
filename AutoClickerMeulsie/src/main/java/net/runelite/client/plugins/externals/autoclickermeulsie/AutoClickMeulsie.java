 ...
 */
package net.runelite.client.plugins.externals.autoclickermeulsie;
...
@Extension
@PluginDescriptor(
	name = "Auto Clicker Meulsie",
	enabledByDefault = false,
	type = PluginType.UTILITY
)
@Slf4j
public class AutoClickMeulsie extends Plugin
{
	@Inject
	private Client client;

	@Inject
	private AutoClickMeulsieConfig config;

	@Inject
	private AutoClickMeulsieOverlay overlay;
	...
	@Provides
	AutoClickMeulsieConfig getConfig(ConfigManager configManager)
	{
		return configManager.getConfig(AutoClickMeulsieConfig.class);
	}
